...
func RegisterConversions(s *runtime.Scheme) error {
	if err := s.AddGeneratedConversionFunc((*Cluster)(nil), (*config.Cluster)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_Cluster_To_config_Cluster(a.(*Cluster), b.(*config.Cluster), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.Cluster)(nil), (*Cluster)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_Cluster_To_v1alpha1_Cluster(a.(*config.Cluster), b.(*Cluster), scope)
	}); err != nil {
		return err
	}
...
// Convert_v1alpha1_Cluster_To_config_Cluster is an autogenerated conversion function.
func Convert_v1alpha1_Cluster_To_config_Cluster(in *Cluster, out *config.Cluster, s conversion.Scope) error {
	return autoConvert_v1alpha1_Cluster_To_config_Cluster(in, out, s)
}
...
// Convert_config_Cluster_To_v1alpha1_Cluster is an autogenerated conversion function.
func Convert_config_Cluster_To_v1alpha1_Cluster(in *config.Cluster, out *Cluster, s conversion.Scope) error {
	return autoConvert_config_Cluster_To_v1alpha1_Cluster(in, out, s)
}
...
func autoConvert_v1alpha1_ControllerConfiguration_To_config_ControllerConfiguration(in *ControllerConfiguration, out *config.ControllerConfiguration, s conversion.Scope) error {
	out.Clusters = *(*[]config.Cluster)(unsafe.Pointer(&in.Clusters))
