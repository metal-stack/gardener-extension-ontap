...
func (m *SvnManager) CreateUserAndSecret(ctx context.Context, opts CreateUserAndSecretOptions) error {
...
func (m *SvnManager) createONTAPUserForSVM(ctx context.Context, opts CreateONTAPUserOptions) (string, error) {
